---
title: 'Cajeta Lambdas & Method References — Specification v1'
layout: '~/layouts/MarkdownLayout.astro'
category: 'Language'
description: '(T1, T2, ..., Tn) -> R is a type. Values of this type are callable with arguments matching the parameter tuple, returning R.'
---
