---
title: 'Cajeta Aspect-Oriented Programming + Dependency Injection — Specification v1'
layout: '~/layouts/MarkdownLayout.astro'
category: 'Language'
description: 'All framework-provided annotations and types in this document live in package cajeta.aot; — @Aspect, @Before, @After, @Around, @AfterReturning, @AfterThrowing, @Order, @Original, @NoAdvice, @Component...'
---
