---
title: 'Cajeta Threading Model — Specification v1'
layout: '~/layouts/MarkdownLayout.astro'
category: 'Language'
description: 'Every async function has return type Task<T>. Awaiting a Task<T> either: - returns the inner T immediately if the task has completed, or - suspends the current task and resumes when the awaited task c...'
---
