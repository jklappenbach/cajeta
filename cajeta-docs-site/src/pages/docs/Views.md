---
title: 'Cajeta Views — Specification v1'
layout: '~/layouts/MarkdownLayout.astro'
category: 'Language'
description: 'A view is a typed overlay onto a byte buffer. Reads and writes go through to the buffer''s bytes directly; no allocation, no copy, no object graph. It is the right choice for:'
---
