...
category: 'Stdlib'
description: 'A design for cajeta.ml, a separate-from-stdlib library scoped to make cajeta a natural choice for machine-learning research and production: n-dimensional tensors, linear algebra, statistics, regressio...'
---
