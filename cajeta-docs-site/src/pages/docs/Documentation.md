...
category: 'Tooling'
description: 'Specification for cajeta source code documentation — the comment syntax authors use, the conventions for what gets documented, the tag set the doc processor understands, and the cajeta doc subcommand ...'
---
...
- **Header.** Class name + signature + fiber-safety badge +
  `@Since`.
