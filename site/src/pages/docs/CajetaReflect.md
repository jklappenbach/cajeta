---
title: 'cajeta.reflect'
layout: '~/layouts/MarkdownLayout.astro'
category: 'Stdlib'
description: 'A design for cajeta.reflect, the stdlib package for runtime type introspection. Reads the per-class RTTI tables the compiler already emits (see StructureMetadata in the compiler: #VTable + #RttiGlobal...'
---
