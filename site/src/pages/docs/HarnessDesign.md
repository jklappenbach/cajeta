...
category: 'Process'
description: 'A stress-test harness for measuring cajeta''s threading model and buffer-pipeline performance, plus the methodology for comparing those numbers against other languages'' concurrency primitives.'
---
