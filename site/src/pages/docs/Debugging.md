...
category: 'Tooling'
description: 'Specification for cajeta''s debugging story: the Debug Adapter Protocol (DAP) server that makes IDE plugin authoring trivial, the Language Server Protocol (LSP) server for editor integration, the Jupyt...'
---
