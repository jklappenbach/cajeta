...
category: 'Stdlib'
description: 'A specification for cajeta.toffee, a deep-learning framework designed from first principles for cajeta — leveraging the type system, ownership model, fiber runtime, and cajeta.ml numerical foundation. ...'
---
...
- **Tensor backing relationship with cajeta.ml.tensor.** toffee's
