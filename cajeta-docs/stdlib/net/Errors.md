# `cajeta.net` — error taxonomy (the consolidated chart)

The complete networking error hierarchy, rooted at
[`cajeta.net.NetException`](../../../../runtime/src/cajeta/net/NetException.cajeta).
...
[`cajeta-docs/Net.md`](../../Net.md) §Design principles).

> **Status — this is the NET-11.6 consolidation.** The whole
> networking taxonomy is gathered here: **every** phase's exceptions
> hang off the single [`NetException`](../../../../runtime/src/cajeta/net/NetException.cajeta)
...
```
  ...
  cajeta_net_err ordinal                      (one value on all OSes)
            │
            │  stage 2 — cajeta.net.NetErrors.fromErrno(ordinal, detail)
            ▼
...
[`runtime/src/cajeta/net/`](../../../../runtime/src/cajeta/net/) today;
...
/ non-blocking hot path** (see [`cajeta-docs/Net.md`](../../Net.md)
...
[hierarchy note](../../../../runtime/src/cajeta/net/uri/MalformedUriException.cajeta).
...
total mapper —
[`ResolveErrors.fromResolveErrno`](../../../../runtime/src/cajeta/net/dns/ResolveErrors.cajeta)
...
[`cajeta-docs/stdlib/ErrorModel.md`](../ErrorModel.md)) — and so does
...
- [`cajeta-docs/Net.md`](../../Net.md) §Error model — the spec table
  this chart consolidates.
- [`cajeta-docs/stdlib/io/file/Errors.md`](../io/file/Errors.md) — the
  sibling file-I/O taxonomy this mirrors.
- [`cajeta-docs/stdlib/ErrorModel.md`](../ErrorModel.md) —
...
- [`runtime/src/cajeta/net/NetException.cajeta`](../../../../runtime/src/cajeta/net/NetException.cajeta)
  — the root + the `KIND_*` ordinal mirror.
- [`runtime/src/cajeta/net/NetErrors.cajeta`](../../../../runtime/src/cajeta/net/NetErrors.cajeta)
  — `fromErrno` (stage 2).
