...
**Current line item:** S6.1 + S6.2 + S6.3 complete — stack alloca + zero-init, aggregate initializer, and class-ref fields all working for structs. Next: S6.4 (drop chain for owned class refs in structs).
