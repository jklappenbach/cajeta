...
|---|---|---|---|
| **CP7-1a** | Alloc-class + ownership metadata in debug-info codegen | FR-1.1–FR-1.4 | compiler / `DebugCodegen` |
| **CP7-1b** | Runtime frame-chain carries facets + host accessors | FR-2.1, FR-2.3 | runtime + host |
