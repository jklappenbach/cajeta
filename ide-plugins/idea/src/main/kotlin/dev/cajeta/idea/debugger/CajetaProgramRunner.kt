 ...
 * [CajetaDebugProcess]. Only handles the Debug executor for a
 * [CajetaRunConfiguration]; the platform's default runner handles plain Run.
 */
class CajetaProgramRunner : AsyncProgramRunner<RunnerSettings>() {
    ...
    override fun canRun(executorId: String, profile: RunProfile): Boolean =
        executorId == DefaultDebugExecutor.EXECUTOR_ID && profile is CajetaRunConfiguration
    ...
    override fun execute(
        ...
        val configuration = environment.runProfile as CajetaRunConfiguration
