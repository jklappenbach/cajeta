...
namespace cajeta {
    ...
    private:
        ...
        list<CajetaStructurePtr> structureStack;
    ...
    public:
        ...
        list<CajetaStructurePtr>& getStructureStack() { return structureStack; }
        ...
        void processMetadata(CajetaStructurePtr structure);
