...
namespace cajeta {
    ...
    public:
         ...
         * @param module
         */
        void populateMetadataGlobals(CajetaStructurePtr structure);
    ...
    private:
         ...
         * @param module
         */
        llvm::Type* createPropertyType(CajetaStructurePtr structure, StructurePropertyPtr property);
         ...
         * @param module
         */
        llvm::Type* createVirtualTableType(CajetaStructurePtr structure);
         ...
         * @return
         */
        llvm::Constant* createVirtualTableConstant(CajetaStructurePtr structure);
         ...
         * @param module
         */
        void createRttiType(CajetaStructurePtr structure);
