...
namespace cajeta {
     ...
     * @param module
     */
    llvm::Type* StructureMetadata::createPropertyType(CajetaStructurePtr structure, StructurePropertyPtr property) {
     ...
     * @param module
     */
    void StructureMetadata::createRttiType(CajetaStructurePtr structure) {
        vector<llvm::Type*> members;
...
//            structure->toCanonical() + string("#RttiType"));
    ...
    llvm::Constant* StructureMetadata::createRttiConstant(vector<llvm::Constant*>& args, CajetaStructurePtr structure) {
        // 0. Version ID
...
//        structure->setRttiGlobal(rttiGlobal);
     ...
     * @return
     */
    llvm::Type* StructureMetadata::createVirtualTableType(CajetaStructurePtr structure) {
        vector<llvm::Type*> members;
    ...
    llvm::Constant* StructureMetadata::createVirtualTableConstant(CajetaStructurePtr structure) {
        vector<llvm::Constant*> args;
