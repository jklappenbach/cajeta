...
namespace cajeta {
    ...
    public:
        ...
        static string buildCanonical(CajetaStructurePtr parent, const string& name, vector<FormalParameterPtr> parameters, bool labeled);

        static string buildCanonical(CajetaStructurePtr parent, const string& name, vector<ParameterEntry> parameters, bool labeled);

        static string buildGeneric(CajetaStructurePtr parent, const string& name, vector<FormalParameterPtr> parameters, bool labeled);

        static string buildGeneric(CajetaStructurePtr parent, const string& name, vector<ParameterEntry> parameters, bool labeled);
