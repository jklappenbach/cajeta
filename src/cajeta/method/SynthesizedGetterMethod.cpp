...
namespace cajeta {
    ...
    void SynthesizedGetterMethod::generateCode() {
        ...
        // generatePrototype has already built (this) -> fieldType; this emits one entry block that GEPs the field, loads it, and returns.
        ...
        // Load at the field's STORAGE type: class refs and arrays store as `ptr`, views and
        // interfaces inline, primitives at their width — the return type uses the same rule.
        llvm::Type* slotType;
