//
// GfxRngTests — cajeta-gfx plan §3 (slice 2): the stateful stream RNG +
// weighted reservoir sampling (cajeta.gpu.Rng).
//
...
const char* IMP = "import cajeta.gpu.Rng;\n";
...
TEST(GfxRngTests, reproducibleAndDistinct) {
...
TEST(GfxRngTests, unitFloatInRange) {
    EXPECT_EQ(runI32(IMP,
...
TEST(GfxRngTests, quartileUniformity) {
    EXPECT_EQ(runI32(IMP,
...
TEST(GfxRngTests, weightedReservoirConverges) {
    EXPECT_EQ(runI32(IMP,
