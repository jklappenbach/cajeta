//
// GfxSobolTests — cajeta-gfx plan §3 (3.b-rest-sobol): the Sobol' (0,2)-sequence
// quasi-random low-discrepancy generator (cajeta.gpu.Sobol).
//
...
const char* IMP =
    "import cajeta.gpu.Sobol;\n"
    "import cajeta.gpu.LowDiscrepancy;\n";
...
TEST(GfxSobolTests, dim0MatchesVanDerCorput) {
...
TEST(GfxSobolTests, dim1KnownValues) {
    EXPECT_EQ(runI32(IMP,
...
TEST(GfxSobolTests, samplesStayInUnitRange) {
    EXPECT_EQ(runI32(IMP,
        "        int32 i = 0;\n"
        "        while (i < 128) {\n"
...
TEST(GfxSobolTests, twoDStratifiedQuadrants) {
    EXPECT_EQ(runI32(IMP,
        "        int32 q0 = 0;\n"
        "        int32 q1 = 0;\n"
        "        int32 q2 = 0;\n"
