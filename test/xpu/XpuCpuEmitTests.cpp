...
// Increment 1).
//
// The SAME portable GPU-style kernel (KernelBuffer<T> + KernelThread.globalIdX()) that
...
// Portable SAXPY: KernelBuffer<T> params + KernelThread.globalIdX() — identical in spirit
