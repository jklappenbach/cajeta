//
// XpuReservoirTests — cajeta-gfx plan §3 (3.b-rest): the reservoir value type +
// RIS/MIS estimators (cajeta.xpu.Reservoir + cajeta.xpu.Ris).
//
...
const char* IMP =
    "import cajeta.xpu.Reservoir;\n"
    "import cajeta.xpu.Ris;\n";
...
TEST(XpuReservoirTests, risUnitWeightSelection) {
...
TEST(XpuReservoirTests, risWeightedAndResolve) {
    EXPECT_EQ(runI32(IMP,
        "        Reservoir r = Ris.empty();\n"
...
// inputs return 0.
TEST(XpuReservoirTests, misHeuristics) {
    EXPECT_EQ(runI32(IMP,
