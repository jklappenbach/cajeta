//
// XpuBvhCodecTests — cajeta-gfx plan §3 (3.a-rest): the bit-reinterpret +
// quantized-node codec for a compressed software BVH (cajeta.xpu.BvhCodec).
//
...
const char* IMP = "import cajeta.xpu.BvhCodec;\n";
...
TEST(XpuBvhCodecTests, reinterpretRoundTripExact) {
...
TEST(XpuBvhCodecTests, bytePackRoundTrip) {
    EXPECT_EQ(runI32(IMP,
