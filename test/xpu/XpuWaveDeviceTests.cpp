...
const char* kReduceSource =
    ...
    "public class M {\n"
    "    @Kernel\n"
    "    public static void wavereduce(KernelBuffer<uint32> in, KernelBuffer<uint32> out) {\n"
    "        uint32 t = KernelThread.x();\n"
...
const char* kWidthSource =
    ...
    "public class M {\n"
    "    @Kernel\n"
    "    public static void wavewidth(KernelBuffer<uint32> out) {\n"
    "        uint32 t = KernelThread.x();\n"
    "        out[t] = Wave.width();\n"
    "    }\n"
    "}\n";
...
const char* kScanSource =
    ...
    "public class M {\n"
    "    @Kernel\n"
    "    public static void wavescan(KernelBuffer<uint32> out, uint32 n) {\n"
    "        uint32 t = KernelThread.x();\n"
