...
// A @Device helper taking Buffer<T> params, on the real NVIDIA device. The kernel
...
// Buffer.slice on CUDA — device-verify the pointer-fold path. The device handle
...
// Bindless Buffer<int32>[] (descriptor-indexed buffers) on CUDA. The launch
