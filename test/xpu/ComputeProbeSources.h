...
inline const char* kNumericsBroadcastReduce() {
    ...
    "        Buffer<float32> sc = heap Buffer<float32>(0, rows);\n"
    "        Buffer<float32> bi = heap Buffer<float32>(0, rows);\n"
    "        Buffer<float32> y = heap Buffer<float32>(0, n);\n"
    "        Buffer<float32> acc = heap Buffer<float32>(0, 1);\n"
...
inline const char* kTorchMatmulScatter() {
    ...
    "        Buffer<float32> A = heap Buffer<float32>(0, nA);\n"
    "        Buffer<float32> B = heap Buffer<float32>(0, nB);\n"
    "        Buffer<float32> C = heap Buffer<float32>(0, nC);\n"
    ...
    "        Buffer<int32> idx = heap Buffer<int32>(0, ns);\n"
    "        Buffer<float32> val = heap Buffer<float32>(0, ns);\n"
    "        Buffer<float32> grad = heap Buffer<float32>(0, P);\n"
...
inline const char* kSpelaFusedLayer() {
    ...
    "        Buffer<float32> W = heap Buffer<float32>(0, nW);\n"
    "        Buffer<float32> x = heap Buffer<float32>(0, inDim);\n"
    "        Buffer<float32> t = heap Buffer<float32>(0, outDim);\n"
    "        Buffer<float32> loss = heap Buffer<float32>(0, outDim);\n"
