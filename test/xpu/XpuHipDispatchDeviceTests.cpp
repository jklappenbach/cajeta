...
// Item 2 follow-up: a @Device helper taking KernelBuffer<T> params, on the real AMD
...
// Bindless KernelBuffer<T>[] (descriptor-indexed buffers) on AMD/HIP. The compiler
