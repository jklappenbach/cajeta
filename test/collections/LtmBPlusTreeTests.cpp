...
TEST(LtmBPlusTreeTests, insertAndLookupWithEviction) {
    ...
    std::string src =
        ...
        "        Encoder<int32> ke = new I32Enc();\n"
        "        Encoder<int32> ve = new I32Enc();\n"
        "        LtmBPlusTree<int32, int32> t ="
        " new LtmBPlusTree<int32, int32>(\"" + path + "\", ke, ve, 4, 6);\n"
        "        int32 i = 0;\n"
        "        while (i < 100) {\n"
        "            t.put(i, i * 2);\n"
        "            i = i + 1;\n"
...
TEST(LtmBPlusTreeTests, persistsAcrossReopen) {
    ...
    std::string src =
        ...
        "        Encoder<int32> ve = new I32Enc();\n"
        "        LtmBPlusTree<int32, int32> t ="
        " new LtmBPlusTree<int32, int32>(\"" + path + "\", ke, ve, 4, 8);\n"
        "        int32 i = 0;\n"
        "        while (i < 200) {\n"
        "            t.put(i, i * 3);\n"
        "            i = i + 1;\n"
        ...
        "        t.flush();\n"
        "        t.close();\n"
        "        Encoder<int32> ke2 = new I32Enc();\n"
        "        Encoder<int32> ve2 = new I32Enc();\n"
        "        LtmBPlusTree<int32, int32> t2 ="
        " new LtmBPlusTree<int32, int32>(\"" + path + "\", ke2, ve2, 4, 8);\n"
        "        int32 ok = 0;\n"
        "        int32 j = 0;\n"
        "        while (j < 200) {\n"
