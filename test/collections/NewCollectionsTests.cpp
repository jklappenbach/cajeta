...
TEST(NewCollectionsTests, immutableListGet) {
    auto src =
        ...
        "        ArrayList<int32> a = new ArrayList<int32>();\n"
        "        a.add(10);\n"
        "        a.add(20);\n"
        "        a.add(30);\n"
        "        ImmutableList<int32> il = new ImmutableList<int32>(a);\n"
...
TEST(NewCollectionsTests, immutableSetDedupContains) {
    auto src =
        ...
        "        a.add(2);\n"
        "        a.add(3);\n"
        "        ImmutableSet<int32> s = new ImmutableSet<int32>(a);\n"
...
TEST(NewCollectionsTests, immutableMapGet) {
    auto src =
        ...
        "public final class D {\n"
        "    public static int32 run() {\n"
        "        ArrayList<Pair<int32, int32>> a = new ArrayList<Pair<int32, int32>>();\n"
        "        a.add(new Pair<int32, int32>(1, 100));\n"
        "        a.add(new Pair<int32, int32>(2, 200));\n"
        "        ImmutableMap<int32, int32> m = new ImmutableMap<int32, int32>(a);\n"
        "        return m.get(2);\n"  // 200
        "    }\n"
        "}\n";
    auto jit = CajetaJit::compile(src, "test.D");
...
TEST(NewCollectionsTests, redBlackManyInsertsLookup) {
    auto src =
        ...
        "public final class D {\n"
        "    public static int32 run() {\n"
        "        RedBlackTree<int32, int32> t = new RedBlackTree<int32, int32>();\n"
        "        int32 i = 0;\n"
        "        while (i < 100) {\n"
        "            t.put(i, i * 2);\n"
        "            i = i + 1;\n"
...
TEST(NewCollectionsTests, bplusManyInsertsForceSplitLookup) {
    auto src =
        ...
        "public final class D {\n"
        "    public static int32 run() {\n"
        "        BPlusTree<int32, int32> t = new BPlusTree<int32, int32>();\n"
        "        int32 i = 0;\n"
