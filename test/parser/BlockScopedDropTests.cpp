...
// a-method pattern that docs/stdlib/Concurrency.md's RAII guard story depends on.
//
...
// The lock-twice-in-a-method pattern from docs/stdlib/Concurrency.md. Pre-block-
