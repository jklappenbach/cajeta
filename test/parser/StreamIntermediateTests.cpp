...
TEST(StreamIntermediateTests, mapOrSkipDropsFailingElements) {
    ...
    auto src =
        ...
        "            (int32 x) -> {\n"
        "                if (x % 3 == 0) {\n"
        "                    throw new RecoverableException(\"skip\");\n"
        "                }\n"
        "                return x * 2;\n"
...
TEST(StreamIntermediateTests, mapOrFallbackSubstitutesValue) {
    ...
    auto src =
        ...
        "            (int32 x) -> {\n"
        "                if (x % 3 == 0) {\n"
        "                    throw new RecoverableException(\"fb\");\n"
        "                }\n"
        "                return x * 2;\n"
