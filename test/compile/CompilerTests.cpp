...
// content: cajeta.lang.Object + cajeta.lang.Pair + cajeta.error.{Throwable,
// Exception, RecoverableException, UnrecoverableException} + cajeta.hash.Hash
...
// when stdlib grows.
static constexpr size_t STDLIB_STRUCTURE_COUNT = 8;
