...
public class MeshletCluster {
    public Buffer<Meshlet>  meshlets;         // 64 verts / 124 prims each
    public Buffer<uint32>   meshletVertices;
    public Buffer<uint8>    meshletTriangles;
