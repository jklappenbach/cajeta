...
error: method 'fold' introduces method-level type parameter 'R'
       ...
       declaration site. See docs/stdlib/MethodLevelTemplate.md.
...
- **Per-lambda type parameters** (`<U> (U) -> U`). Same vtable
  constraint, separate grammar work. See `docs/stdlib/Lambdas.md`
...
- `docs/stdlib/Streams.md:245-246` — "needs method-level type
