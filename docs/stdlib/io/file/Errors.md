...
`docs/stdlib/ErrorModel.md`). Every IO-using call site
either:
...
see `docs/BuildTool.md` for the manifest shape.
...
(`docs/AsyncStatus.md`) gates them in — adding them
