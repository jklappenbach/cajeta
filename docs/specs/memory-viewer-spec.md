...
> [`docs/Debugging.md`](../Debugging.md) (DAP contract),
> [`docs/specs/frame-arena-spec.md`](frame-arena-spec.md) (the bump arena),
> [`docs/specification/lang/MemoryModel.md`](specification/lang/MemoryModel.md)
> (ownership/drop), [`docs/Embedded.md`](../Embedded.md) (target tiers + per-tier
