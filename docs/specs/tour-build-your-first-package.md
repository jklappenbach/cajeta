...
`docs/`; this tour is the **build-tool** introduction.
...
- `docs/BuildTool.md` — full spec.
- `docs/specs/manifest-v1.json` — formal manifest schema.
- `docs/specs/action-catalog-v1.json` — action-by-action contract.
- `docs/specs/extension-api-v1.md` — write your own plugin.
- `docs/specs/repository-protocol-v1.md` — host your own registry.
- `docs/specs/toolchain-registry-v1.md` — host your own toolchain
  distribution.
