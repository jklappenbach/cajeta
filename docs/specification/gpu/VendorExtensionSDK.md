...
project explicitly. Importing it **is** the lock-in declaration (`import cajeta.xpu.nvidia.*`
...
- ✅ the `cajeta.xpu.core → cajeta.xpu` rename.
...
- Foundation plan — `../../plans/gpu/cajeta-gpu-plan.md`
