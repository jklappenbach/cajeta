...
- `docs/specification/lang/MemoryModel.md` — the borrow / move / drop doctrine. v2 preserves all rules; only the storage-choice mechanism (stack vs heap) is new.
- `docs/specification/lang/Views.md` — typed overlays onto byte buffers. Unaffected.
