...
A stack instance lives in the current frame's stack region. Its drop entry runs the destructor at the declaring block's closing brace like any other; the bytes themselves are reclaimed at frame teardown.
