...
**Current:** `0.29.0` &nbsp;·&nbsp; baked into the binary at configure time — `cajeta --version` reports it.

**[Release notes and every asset →](https://github.com/jklappenbach/cajeta/releases/tag/v0.29.0)**

| Platform | Triple | Archive | Compiler | Installer |
|---|---|---|---|---|
| Linux x86_64 | `x86_64-linux-gnu` | [`.tar.gz`](https://github.com/jklappenbach/cajeta/releases/download/v0.29.0/cajeta-v0.29.0-x86_64-linux-gnu.tar.gz) | [binary](https://github.com/jklappenbach/cajeta/releases/download/v0.29.0/cajeta-v0.29.0-x86_64-linux-gnu) | [`cvm`](https://github.com/jklappenbach/cajeta/releases/download/v0.29.0/cvm-v0.29.0-x86_64-linux-gnu) |
| Linux ARM64 | `aarch64-linux-gnu` | [`.tar.gz`](https://github.com/jklappenbach/cajeta/releases/download/v0.29.0/cajeta-v0.29.0-aarch64-linux-gnu.tar.gz) | [binary](https://github.com/jklappenbach/cajeta/releases/download/v0.29.0/cajeta-v0.29.0-aarch64-linux-gnu) | — |
| macOS Apple Silicon | `aarch64-apple-darwin` | [`.tar.gz`](https://github.com/jklappenbach/cajeta/releases/download/v0.29.0/cajeta-v0.29.0-aarch64-apple-darwin.tar.gz) | [binary](https://github.com/jklappenbach/cajeta/releases/download/v0.29.0/cajeta-v0.29.0-aarch64-apple-darwin) | — |
| Windows x86_64 | `x86_64-w64-mingw32` | [`.zip`](https://github.com/jklappenbach/cajeta/releases/download/v0.29.0/cajeta-v0.29.0-x86_64-w64-mingw32.zip) | [binary](https://github.com/jklappenbach/cajeta/releases/download/v0.29.0/cajeta-v0.29.0-x86_64-w64-mingw32.exe) | — |
