...
**Current:** `0.29.1` &nbsp;·&nbsp; baked into the binary at configure time — `cajeta --version` reports it.

**[Release notes and every asset →](https://github.com/jklappenbach/cajeta/releases/tag/v0.29.1)**

| Platform | Triple | Archive | Compiler | Installer | cvm |
|---|---|---|---|---|---|
| Linux x86_64 | `x86_64-linux-gnu` | [`.tar.gz`](https://github.com/jklappenbach/cajeta/releases/download/v0.29.1/cajeta-v0.29.1-x86_64-linux-gnu.tar.gz) | [binary](https://github.com/jklappenbach/cajeta/releases/download/v0.29.1/cajeta-v0.29.1-x86_64-linux-gnu) | [`.rpm`](https://github.com/jklappenbach/cajeta/releases/download/v0.29.1/cajeta-0.29.1-1.x86_64.rpm) [`.deb`](https://github.com/jklappenbach/cajeta/releases/download/v0.29.1/cajeta_0.29.1_amd64.deb) | [`cvm`](https://github.com/jklappenbach/cajeta/releases/download/v0.29.1/cvm-v0.29.1-x86_64-linux-gnu) |
| Linux ARM64 | `aarch64-linux-gnu` | [`.tar.gz`](https://github.com/jklappenbach/cajeta/releases/download/v0.29.1/cajeta-v0.29.1-aarch64-linux-gnu.tar.gz) | [binary](https://github.com/jklappenbach/cajeta/releases/download/v0.29.1/cajeta-v0.29.1-aarch64-linux-gnu) | [`.rpm`](https://github.com/jklappenbach/cajeta/releases/download/v0.29.1/cajeta-0.29.1-1.aarch64.rpm) [`.deb`](https://github.com/jklappenbach/cajeta/releases/download/v0.29.1/cajeta_0.29.1_arm64.deb) | [`cvm`](https://github.com/jklappenbach/cajeta/releases/download/v0.29.1/cvm-v0.29.1-aarch64-linux-gnu) |
| macOS Apple Silicon | `aarch64-apple-darwin` | [`.tar.gz`](https://github.com/jklappenbach/cajeta/releases/download/v0.29.1/cajeta-v0.29.1-aarch64-apple-darwin.tar.gz) | [binary](https://github.com/jklappenbach/cajeta/releases/download/v0.29.1/cajeta-v0.29.1-aarch64-apple-darwin) | [`.pkg`](https://github.com/jklappenbach/cajeta/releases/download/v0.29.1/cajeta-0.29.1-arm64.pkg) | [`cvm`](https://github.com/jklappenbach/cajeta/releases/download/v0.29.1/cvm-v0.29.1-aarch64-apple-darwin) |
| Windows x86_64 | `x86_64-w64-mingw32` | [`.zip`](https://github.com/jklappenbach/cajeta/releases/download/v0.29.1/cajeta-v0.29.1-x86_64-w64-mingw32.zip) | [binary](https://github.com/jklappenbach/cajeta/releases/download/v0.29.1/cajeta-v0.29.1-x86_64-w64-mingw32.exe) | [`.msi`](https://github.com/jklappenbach/cajeta/releases/download/v0.29.1/cajeta-0.29.1-AMD64.msi) | [`cvm`](https://github.com/jklappenbach/cajeta/releases/download/v0.29.1/cvm-v0.29.1-x86_64-w64-mingw32.exe) |
