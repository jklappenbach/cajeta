...
<!-- BEGIN:RELEASE — generated by scripts/update-release-docs.sh, run from the release workflow. Anything between these markers is replaced on the next release. -->
**Current:** `0.30.0` &nbsp;·&nbsp; baked into the binary at configure time — `cajeta --version` reports it.

**[Release notes and every asset →](https://github.com/jklappenbach/cajeta/releases/tag/v0.30.0)**

| Platform | Triple | Archive | Compiler | Installer | cvm | cvm installer |
|---|---|---|---|---|---|---|
| Linux x86_64 | `x86_64-linux-gnu` | [`.tar.gz`](https://github.com/jklappenbach/cajeta/releases/download/v0.30.0/cajeta-v0.30.0-x86_64-linux-gnu.tar.gz) | [binary](https://github.com/jklappenbach/cajeta/releases/download/v0.30.0/cajeta-v0.30.0-x86_64-linux-gnu) | [`.rpm`](https://github.com/jklappenbach/cajeta/releases/download/v0.30.0/cajeta-0.30.0-1.x86_64.rpm) [`.deb`](https://github.com/jklappenbach/cajeta/releases/download/v0.30.0/cajeta_0.30.0_amd64.deb) | [`cvm`](https://github.com/jklappenbach/cajeta/releases/download/v0.30.0/cvm-v0.30.0-x86_64-linux-gnu) | [`.rpm`](https://github.com/jklappenbach/cajeta/releases/download/v0.30.0/cajeta-cvm-0.2.0-1.x86_64.rpm) [`.deb`](https://github.com/jklappenbach/cajeta/releases/download/v0.30.0/cajeta-cvm_0.2.0_amd64.deb) |
| Linux ARM64 | `aarch64-linux-gnu` | [`.tar.gz`](https://github.com/jklappenbach/cajeta/releases/download/v0.30.0/cajeta-v0.30.0-aarch64-linux-gnu.tar.gz) | [binary](https://github.com/jklappenbach/cajeta/releases/download/v0.30.0/cajeta-v0.30.0-aarch64-linux-gnu) | [`.rpm`](https://github.com/jklappenbach/cajeta/releases/download/v0.30.0/cajeta-0.30.0-1.aarch64.rpm) [`.deb`](https://github.com/jklappenbach/cajeta/releases/download/v0.30.0/cajeta_0.30.0_arm64.deb) | [`cvm`](https://github.com/jklappenbach/cajeta/releases/download/v0.30.0/cvm-v0.30.0-aarch64-linux-gnu) | [`.rpm`](https://github.com/jklappenbach/cajeta/releases/download/v0.30.0/cajeta-cvm-0.2.0-1.aarch64.rpm) [`.deb`](https://github.com/jklappenbach/cajeta/releases/download/v0.30.0/cajeta-cvm_0.2.0_arm64.deb) |
| macOS Apple Silicon | `aarch64-apple-darwin` | [`.tar.gz`](https://github.com/jklappenbach/cajeta/releases/download/v0.30.0/cajeta-v0.30.0-aarch64-apple-darwin.tar.gz) | [binary](https://github.com/jklappenbach/cajeta/releases/download/v0.30.0/cajeta-v0.30.0-aarch64-apple-darwin) | [`.pkg`](https://github.com/jklappenbach/cajeta/releases/download/v0.30.0/cajeta-0.30.0-arm64.pkg) | [`cvm`](https://github.com/jklappenbach/cajeta/releases/download/v0.30.0/cvm-v0.30.0-aarch64-apple-darwin) | [`.pkg`](https://github.com/jklappenbach/cajeta/releases/download/v0.30.0/cajeta-cvm-0.2.0-Darwin.pkg) |
| Windows x86_64 | `x86_64-w64-mingw32` | [`.zip`](https://github.com/jklappenbach/cajeta/releases/download/v0.30.0/cajeta-v0.30.0-x86_64-w64-mingw32.zip) | [binary](https://github.com/jklappenbach/cajeta/releases/download/v0.30.0/cajeta-v0.30.0-x86_64-w64-mingw32.exe) | [`.msi`](https://github.com/jklappenbach/cajeta/releases/download/v0.30.0/cajeta-0.30.0-AMD64.msi) | [`cvm`](https://github.com/jklappenbach/cajeta/releases/download/v0.30.0/cvm-v0.30.0-x86_64-w64-mingw32.exe) | — |
...
Step 3 finishes by rewriting the version line and download table above from
the assets that release actually published, and commits the result to `main`.
