...
(`cajetadoc` is only a plan: `plans/cajetadoc-tool.md`). Of the 15, only `@complexity`
...
### `plans/cajetadoc-tool.md` (cajetadoc build plan)
...
- **Doc + plan `.md`:** `cajeta-docs/Documentation.md`, `cajeta-docs/BuildTool.md`,
  `plans/cajetadoc-tool.md`, `plans/cajeta-site-plan.md`, and the two stale Astro copies
