...
> they extend are in [`buildtool-widget-spec.md`](archive/buildtool-widget-spec.md).
>
> Grounds in [`docs/Embedded.md`](../docs/specification/embedded/Embedded.md) (target tiers T1–T4, modes
> E1–E10, per-tier size targets), [`docs/Debugging.md`](../docs/specification/debugging/Debugging.md) (DAP),
> and [`docs/BuildTool.md`](../docs/specification/buildtool/BuildTool.md) (`${target}` triple, `cajeta
