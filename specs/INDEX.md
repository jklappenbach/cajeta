...
| [compiler-jsonl](compiler-jsonl-spec.md) | [plan](../agents/compiler-jsonl-plan.md) | active — approved 2026-07-31; Unit 1 delivered (every record carries `kind`, stream-opening version record, text mode byte-identical); next Unit 2 (version negotiation) |
