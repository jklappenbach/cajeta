...
| [compiler-jsonl](compiler-jsonl-spec.md) | [plan](../agents/compiler-jsonl-plan.md) | active — approved 2026-07-31 (§9 decided: stream-opening version record, verbatim `log`, plugin-runtime deferred, `result` from every verb); Unit 1 in progress |
