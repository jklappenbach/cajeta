...
| [json-viewer](json-viewer-spec.md) | [plan](../agents/json-viewer-plan.md) | active — approved 2026-07-28 (console-first: in-place JSON toggle on run/debug session consoles + diagnostic row navigation; binary JSON FINAL unit; 1.3.2 drafted JSONC-only leniency); Unit 1 in progress |
