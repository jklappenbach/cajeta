...
| [json-viewer](json-viewer-spec.md) | [plan](../agents/json-viewer-plan.md) | draft — console-first per 2026-07-28 review: in-place JSON toggle on run/debug session consoles + diagnostic row navigation, then editor editing; binary JSON is the FINAL unit; one open item (1.3.2 JSON5 depth) |
