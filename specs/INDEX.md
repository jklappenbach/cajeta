...
| [json-viewer](json-viewer-spec.md) | [plan](../agents/json-viewer-plan.md) | draft — one JSON surface: console (JSONL + mixed/raw + compiler NDJSON) and editor (json/jsonc/jsonl + MessagePack/CBOR via codec seam, structured editing); generalizes the shipped jsonl package; awaiting Julian review of spec 1.3.1-1.3.3 |
