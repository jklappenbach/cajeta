...
| [ide-symbol-index](ide-symbol-index-spec.md) | [plan](../agents/ide-symbol-index-plan.md) | active — compiler-authoritative xref export + PSI presentation layer; foundation for ide-features |
