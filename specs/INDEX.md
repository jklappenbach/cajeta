...
| [ide-symbol-index](ide-symbol-index-spec.md) | [plan](../agents/ide-symbol-index-plan.md) | active — Units 1-9 implemented and green; awaiting live-IDE acceptance passes (7.3, 8.3, 9.3). 8.3.1 (dependency Ctrl-click) fixed twice on 2026-07-18 — static-receiver capture, then the per-edit lint shard clobber; needs a CLion restart to confirm live |
