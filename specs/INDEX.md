...
| [compiler-jsonl](compiler-jsonl-spec.md) | [plan](../agents/compiler-jsonl-plan.md) | active — approved 2026-07-31; Units 1-2 delivered (every record carries `kind`; stream-opening version record; reader-side refuse-unknown-major / skip-unknown-kind / legacy-stream tolerance); next Unit 3 (structure the narration) |
