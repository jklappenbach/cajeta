...
| CajetaTorch.md | retired 2026-08-08 | deleted; superseded by specification/nucleo/torch-facade-spec.md |
...
1. ~~CajetaTorch.md: diff against torch-facade-spec for unique API-mapping content before retiring.~~
   Resolved 2026-08-08: torch-facade-spec covers the surface and contradicts CajetaTorch's
   separate-`Tensor` premise (the façade skins stdlib `cajeta.math.Tensor`). Retired, no content salvaged.
